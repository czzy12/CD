...
- 自动对照范围固定为工作单位、申报行业或经营内容、下定定金支出；下定项只接受支出交易，并须命中明确下定/定金词或系统车型、经销商、门店及下定描述中的识别词。
- 工作地点、住家地址、车辆上牌地点、车型、经销商、门店和下定描述进入 `display_only_items`，只展示系统值、来源角色、来源引用和核实状态，不与流水匹配，不生成不一致结论。
