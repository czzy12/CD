...
from .changsha_bank_corp import extract_changsha_bank_corp
...
from .huaxia_corp import extract_huaxia_corp
...
from .tianjin_rural_corp import extract_tianjin_rural, extract_tianjin_rural_corp
...
def _extract_transactions(pdf_path: str, bank: str = "icbc") -> list[Transaction]:
    ...
    if bank == "huaxia_corp":
        return extract_huaxia_corp(pdf_path)
    if bank == "guilin":
    ...
    if bank == "changsha_bank_corp":
        return extract_changsha_bank_corp(pdf_path)
    ...
    if bank == "fudian":
        return extract_fudian(pdf_path)
    if bank == "abc":
    ...
    if bank == "bazhou_shunfeng_corp":
        return extract_bazhou_shunfeng_corp(pdf_path)
    if bank == "hebei_corp_detail":
    ...
    if bank == "luzhou":
        return extract_luzhou(pdf_path)
    if bank == "psbc":
    ...
    if bank == "tianjin_rural":
        return extract_tianjin_rural(pdf_path)
    if bank == "cmbc":
