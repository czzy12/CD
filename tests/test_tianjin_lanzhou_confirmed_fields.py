...
class TianjinLanzhouConfirmedFieldTests(unittest.TestCase):
    def test_tianjin_rural_keeps_only_confirmed_personal_headers(self):
        row = {
            "交易日期": "20260513",
            "交易时间": "19:05:40",
            "交易摘要": "快捷支付",
        ...
        self.assertNotIn("对手账号", tx.raw_headers)
        self.assertEqual(tx.source_fields["transaction_channel_raw"], "农信银系统")

    def test_lanzhou_excludes_sequence_and_counterparty_account(self):
        ...
        self.assertNotIn("对方帐号", tx.raw_headers)
