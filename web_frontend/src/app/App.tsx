...
function SettingsPage({ caseName, loading, context, draft, notice, error, onDraftChange, onSave, onClose }: { caseName: string; loading: boolean; context: ManualContextDTO | null; draft: ManualContextInput; notice: string; error: string; onDraftChange: (next: ManualContextInput) => void; onSave: () => void; onClose: () => void }) {
